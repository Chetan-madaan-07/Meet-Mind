...
import NativeMeetingRoomScreen from "./NativeMeetingRoomScreen";
import { TranscriptionSocketClient } from "../services/transcriptionSocket";
import { stopMeeting } from "../services/api";
          ...
          <View style={styles.transcriptCard}>
            ...
            <ScrollView ref={transcriptScrollRef} style={styles.transcriptScroll}>
              {transcriptLines.length ? (
                ...
                <Text style={styles.transcriptEmpty}>No transcript yet. Send chunks after joining.</Text>
              )}
            </ScrollView>
